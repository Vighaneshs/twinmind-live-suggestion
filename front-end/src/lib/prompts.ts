...
Good batch:
  [
    {"type":"fact_check","title":"Slack's early MAU comparison looks off","preview":"Slack reported ~2M DAU (not MAU) by late 2015, so the doubling claim conflates two different metrics."},
    {"type":"question","title":"Ask which Slack vintage we're comparing to","preview":"Suggested ask: \\"Do you mean Slack's 2014, 2015, or post-IPO numbers : the answer changes the comparison by 5–10x?\\""},
    {"type":"talking_point","title":"Retention matters more than MAU here","preview":"4M MAU is only meaningful paired with a D30 retention curve, otherwise the Slack comparison is misleading."}
  ]

[RECENTLY SAID] tail: "...what does 'RAG' even mean in this context?"
Good batch:
  [
    {"type":"clarification","title":"RAG = Retrieval-Augmented Generation","preview":"RAG fetches relevant documents at query time and injects them into the LLM's context instead of relying on training data alone."},
    {"type":"answer","title":"In this product it likely means doc search + LLM","preview":"Given the earlier mention of 'customer PDFs', RAG here likely means embedding those PDFs and retrieving top-k chunks per query."},
    {"type":"question","title":"Ask whether retrieval is semantic or keyword","preview":"Suggested ask: \\"Are we using embedding-based retrieval or BM25 : that determines latency, infra, and failure modes?\\""}
  ]
